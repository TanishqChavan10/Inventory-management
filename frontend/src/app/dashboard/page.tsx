...
import CategoryRevenue from '@/components/dashboard/CategoryRenvenue';
import LowStockAlert from '@/components/dashboard/LowStockAlert';
import DashboardModal from '@/components/dashboard/DashboardModal';
import { statsData, revenueByCategory, lowStockItems } from '@/data/dashboardData';
  ...
  return (
    <div className="px-32 py-8 min-h-screen bg-gray-50 dark:bg-neutral-950">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <CategoryRevenue activities={revenueByCategory} />
