      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <Badge 
            ...
            className={supplier.status === 'Active' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-gray-100 text-gray-700 dark:bg-neutral-700 dark:text-gray-300'}
          >
            {supplier.status}
          </Badge>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-neutral-700 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">{supplier.registration_number || 'N/A'}</p>
          </div>
        </div>
