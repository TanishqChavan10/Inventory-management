          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <p className="text-xs text-gray-600">
                +{overview.growthRate}% from last period
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {topProducts.map((product, index) => (
              <div key={product.product_id} className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-4 last:border-0">
                ...
                <div className="flex items-center space-x-6">
                  <div className="text-center">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">{product.total_sold}</p>
                  ...
                  <div className="text-center">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">${product.avg_price.toFixed(2)}</p>
              ...
              {paymentMethods.map((payment) => (
                <div key={payment.method} className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-medium text-gray-900 dark:text-white">${payment.total_amount.toLocaleString()}</p>
